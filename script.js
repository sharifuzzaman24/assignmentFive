...
document
  .getElementById("donate_to_noakhali")
  .addEventListener("click", function (event) {
    ...
    if (
      isNaN(noakhaliDonation) ||
      noakhaliDonation <= 0 ||
      noakhaliDonation > mainBalance
    ) {
    ...
    const noakhaliDonationTotal = getTextFieldValueById(
      "noakhali_donation_total"
    );
    ...
    document.getElementById("noakhali_donation_total").innerText =
      newNoakhaliDonationTotal;
...
document
  ...
  .addEventListener("click", function (event) {
    ...
    document.getElementById("quota_donation_total").innerText =
      newQuotaDonationTotal;
    document.getElementById("main_balance").innerText = newMainBalance;
    modal.showModal();
...
document
  .getElementById("feni_donation-btn")
  .addEventListener("click", function (event) {
    event.preventDefault();
    ...
    document.getElementById("feni_donation_total").innerText =
      newFeniDonationTotal;
    document.getElementById("main_balance").innerText = newMainBalance;
    modal.showModal();
